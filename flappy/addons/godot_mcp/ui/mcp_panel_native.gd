...
func _create_settings_tab() -> VBoxContainer:
    ...
    transport_title.text = "Transport Settings:"
    ...
    transport_label.text = "Transport Mode:"
    ...
    _auth_enabled_check.text = "Enable Authentication"
    ...
    _auth_token_edit.placeholder_text = "Enter authentication token"
    ...
    _sse_enabled_check.text = "Enable SSE"
    ...
    _allow_remote_check.text = "Allow Remote Access"
