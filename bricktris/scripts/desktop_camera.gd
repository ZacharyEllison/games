...
static func preset_name(p: Preset) -> String:
	match p:
		Preset.ORBIT: return "Orbit"
		Preset.FRONT: return "Front"
		Preset.TOP: return "Top"
		Preset.ORTHO: return "Ortho"
		Preset.LEFT: return "Left"
		Preset.RIGHT: return "Right"
		Preset.ISO: return "Iso"
	return "Orbit"
